...
func (act *action) execOnce() {
	...
	TODO(hyangah): This was added in https://go-review.googlesource.com/c/tools/+/222761/27/go/analysis/internal/checker/checker.go

	The dependency on golang.org/x/tools/internal/analysisinternal.SetTypeErrors makes
	vendoring the analysis/internal/checker package difficult.
	We are not currently depending on the type errors & quickfix. So, let's skip this part.
