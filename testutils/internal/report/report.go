...
// Package report contains functionality copied from
// golang.org/x/vulndb/internal/report. The package is
// for parsing and linting YAML reports written in the
// format described in golang.org/x/vulndb/doc/format.md.
package report
...
// Read reads a Report in YAML format.
func Read(in io.Reader) (_ *Report, err error) {
